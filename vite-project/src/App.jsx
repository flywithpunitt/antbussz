    ...
    <div className="min-h-screen relative overflow-hidden">
      ...
      <main className="relative h-[calc(100vh-88px)]">
        ...
        <div className="relative z-10 flex flex-col items-center h-full text-black px-4 sm:px-6 md:px-8" style={{ paddingTop: '5vh' }}>
          <div className="bg-[#FF5722] px-4 sm:px-8 md:px-16 py-3 sm:py-4 md:py-6 rounded-lg mb-4 md:mb-6 shadow-lg w-fit">
            <h2 className="text-2xl sm:text-3xl md:text-5xl font-bold text-white text-center">Coming Soon!</h2>
          </div>
          <h1 className="text-2xl sm:text-3xl md:text-6xl font-bold text-center mb-4 md:mb-6 px-2">
            Our new website is on its way.
          </h1>
          <div className="max-w-[90%] sm:max-w-2xl md:max-w-3xl mx-auto text-center space-y-2 sm:space-y-3 md:space-y-4">
            ...
            <h3 className="text-base sm:text-lg md:text-xl text-center text-gray-700">
              Hassle-Free, Long-Term Staff Transport Contracts,
            </h3>
            <h3 className="text-base sm:text-lg md:text-xl text-center text-gray-700 mb-4 sm:mb-5 md:mb-6">
              Outstation, Events, and More!
            </h3>
            <p className="text-base sm:text-lg md:text-xl text-center text-[#FF5722] font-medium bg-white/80 py-2 px-3 sm:px-4 rounded-full inline-block mx-auto">
      ...
      {showContact && <ContactPopup isOpen={showContact} onClose={() => setShowContact(false)} />}
      {showForm && <EnquiryForm isOpen={showForm} onClose={() => setShowForm(false)} />}
      {showOperatorForm && <OperatorForm isOpen={showOperatorForm} onClose={() => setShowOperatorForm(false)} />}
